  ...
  <div class="search-panel">
    <Form ref="form" @keydown.enter.native="handleSubmit" :label-width="80" :model="keywords">
      ...
      <Col span="12">
        <Col span="12">
          <FormItem label="出质人">
              <Input style="width:300px" type="text" placeholder="匹配关键字" v-model="keywords.pledgor"></Input>
          </FormItem>
        </Col>
      </Col>
      <Col span="12">
        <Col span="12">
          <FormItem label="质权人">
              <Input style="width:300px" type="text" placeholder="匹配关键字" v-model="keywords.pledgee"></Input>
          </FormItem>
        </Col>
      </Col>
    </Row>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.set_spin(true);
      this.get_equity(keywords).then(() => this.set_spin(false));
    }
  },
  components:{
    CompanyAutoComplete,
